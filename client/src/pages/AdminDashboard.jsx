...
click={()=>navigate("/create-lecturer")}
...
click={()=>navigate("/manage-students")}
...
click={()=>navigate("/manage-lecturers")}
...
click={()=>navigate("/manage-timetable")}
...
click={()=>navigate("/admin-resources")}
